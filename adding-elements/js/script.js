...
/* 
  ...
  //adding a new box to every box as a sibling
/*   $(".red-box").after("<div class='red-box'>red2</div>");
  $(".green-box").after("<div class='green-box'>green2</div>");
  $(".blue-box").after("<div class='blue-box'>blue2</div>"); */
  
  //$("p").replaceWith($(".green-box"))
  $(".blue-box").replaceWith("<div class='green-box'>Green2</div>")
  $(".red-box").replaceWith("<div class='green-box'>Green2</div>")
  //$("li").replaceWith($(".green-box"))
  //$("p").replaceWith($(".green-box"))
 // $(".blue-box").replaceWith("<div class=.green-box>green</div>")
});
